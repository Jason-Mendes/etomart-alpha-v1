...
const CartIcon = () => {
  ...
  return (
    <div className="relative cursor-pointer " onClick={handleCartClick}>
      ...
      >
        <span className="icon-container absolute left-[-50px] z-50 flex size-8 items-center justify-center overflow-hidden rounded-full bg-transparent transition duration-500">
          <svg
        ...
        <p className="text z-50 flex h-full items-center justify-center text-lg font-bold text-[#ee9613] transition duration-500">
          Cart
        </p>
      </button>
    </div>

      ...
      >
        ...
        >
          ...
          <div
            ...
            className="flex flex-col md:flex-row items-center justify-center flex-grow"
          >
            {/* Left side: Image */}
            ...
            <div className="flex flex-col justify-center md:ml-16 w-full md:w-1/2">
              <h2 className="text-center text-[#000000] text-2xl md:text-3xl lg:text-4xl font-Agbalumo font-bold mb-6">
                Let's Have a Feast!
              </h2>
              ...
              {/* Signup buttons */}
              <button
                onClick={handleAuthenticatedSignupLinkClick}

...
function  Footer()  {
  ...
  return (
    <div>
      ...
      <div id="LP_section_3_orange" className="bg-[#ee9613] p-4 border border-solid border-white-A700_19 rounded-tl-[150px] rounded-tr-[150px] shadow-xl relative" style={{ width: '100%', maxWidth: '100vw', margin: '0 auto' }}>
          ...
          <div className="container mx-auto flex flex-col md:flex-row justify-between items-center bg-[#ee9613] py-4">
            ...
            <div className="flex items-center space-x-4 text-zinc-950 font-Agbalumo mt-4 md:mt-0">
              ...
              <div  className="flex flex-col ">
                ...
                <p className="flex items-center justify-center text-sm sm:text-sm md:text-sm lg:text-sm max-w-base"> All Rights Reserved</p>
              </div>
            </div>
          </div>
        </div>

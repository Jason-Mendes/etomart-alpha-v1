...
const PersonalProfile = () => {
  const [user, setUser] = useState({
    ...
    profileImage: 'https://consumer-user.Etomart.com/s/LGMk-ih4mlfnDceZkczqmpU-HcL5gZS3OBfrMHvpzkM/JM/0'
  });
        ...
        <div className="flex items-center mb-6">
          <div className="relative mr-6">
            ...
            <div className="absolute bottom-0 right-0 flex space-x-2">
              <label htmlFor="file-upload" className="cursor-pointer bg-white text-blue-600 px-2 py-1 rounded-full text-sm font-medium shadow-sm hover:bg-gray-50">
                Edit
              </label>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        <div className="flex justify-between items-center mb-4">
          ...
          <button
            ...
            className="flex items-center bg-white text-blue-600 px-3 py-1 rounded-full text-sm font-medium border border-blue-600 hover:bg-blue-50"
          >
      ...
      <div className="space-y-6">
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="flex justify-between items-center">
            <button className="text-blue-600 font-medium">View tokens</button>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="flex justify-between items-center">
            <button className="text-blue-600 font-medium">View credits</button>

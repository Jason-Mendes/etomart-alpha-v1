...
const storescards1 = [
  ...
  const MARKER_COORDINATES = [
    { lng: 17.09449450474923, lat: -22.584210677171924 }, // Joe's Beerhouse
  ...
  const initializeMap = (mapContainer) => {
    ...
    mapInstance.fitBounds(bounds, {
      padding: { top: 35, bottom: 300, left: 20, right: 20 },
      maxZoom: 15,
      linear: true
    });
  ...
  return (
    <div>
      ...
      <div className="relative">
        <div id="mainContent" tabIndex="-1" className="flex flex-col items-center">

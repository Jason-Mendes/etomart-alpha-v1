      ...
      <div data-test-id="navigation-bar" className="sc-adf1bc0c-2 exbBdY">
        {navcategories.map((category, index) => (
          <div key={index} className="sc-adf1bc0c-8 iWbiGw">
            <a data-test-id="navigation-bar-link" className="sc-dad41f1f-0 QHyej" href={category.href}>
              <div className="sc-dad41f1f-2 issrEq">
                <span className="sc-af12669c-0 fziZJo sc-dad41f1f-3 bIkfsI cb-elevated cb_elevation_elevationXsmall_equ2">
                  <img loading="lazy" decoding="async" sizes="(min-width: 1024px) 5vw, (min-width: 640px) 7vw, 100vw" srcSet={category.imgSrc} src={category.imgSrc} alt="" draggable="true" className="sc-af12669c-1 bmIuLw" />
                </span>
              </div>
              <div data-test-id="NavigationListItem-title" className="sc-dad41f1f-6 iuZpCn">{category.name}</div>
            </a>
          </div>
        ))}
      </div>

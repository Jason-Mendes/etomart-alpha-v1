                    ...
                    <div className="w-1/4 p-4">
                      <div className="flex flex-col">
                        <div className="flex items-center mb-4">
                          ...
                          />
                          <svg viewBox="0 0 24 24" aria-hidden="true" className="w-6 h-6 ml-2 text-gray-500">
                        ...
                        <div className="flex flex-col overflow-y-auto" style={{ height: '800px' }}>
                          {filteredCategories.slice(0, 20).map((category, index) => (
                            ...
                            >
                              <img src={category.imgSrc} alt={category.name} className="w-10 h-10 mr-4 rounded-full" />
                                    ...
                                    <div className="flex flex-col w-full p-0 mb-4">
                                      <div className="flex flex-col w-full">
                                        ...
                                        <div className="flex flex-row h-full">
                                          ...
                                          <div className="text-xs text-gray-500 flex-grow -mb-4" style={{ height: '50px' }}>

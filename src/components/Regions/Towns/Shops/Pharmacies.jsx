        ...
        <div>
            ...
            <div className="relative z-10">
                    ...
                    <div className="relative z-10 flex items-center justify-center w-full mb-0">
                        <div className="sc-6db52481-0 kZFPSm cb-elevated cb_elevation_elevationMedium_e16y">
                            <div role="tablist" className="flex space-x-2 gap-2">
                                ...
                                <a role="tab" aria-selected="false" className="flex items-center gap-2 px-4 py-2 rounded-full bg-white shadow-md transition-all hover:bg-orange-300 duration-150" href="/LP/Khomas/Towns/Restaurants">
                                    <svg viewBox="0 0 24 24" className="w-6 h-6 fill-current text-black">
                                ...
                                <a role="tab" aria-selected="false" className="flex items-center space-x-2 gap-2 px-4 py-2 rounded-full shadow-md bg-orange-300 transition duration-150" href="/LP/Khomas/Towns/Pharmacies">
                                    <svg viewBox="0 0 24 24" className="w-6 h-6 fill-current text-black">
                ...
                <div className="relative">
                    ...
                    <div className="absolute right-0 top-0 bottom-0 w-16 bg-gradient-to-l from-white to-transparent z-10 pointer-events-none"></div>
                    {/* Left Button */}
                    <button className="absolute left-0 top-1/2 transform -translate-y-1/2 bg-[#ee9613] p-2 rounded-br-[150px] rounded-tr-[150px] z-20" onClick={() => scrollLeft(pharmaciesscroll)}>
                        &#9664; {/* Left Arrow */}
                    </button>
                                ...
                                <a href={category.href}>
                                    <div className="flex-col items-center justify-center rounded-t-lg bg-slate-50 rounded-lg shadow-md hover:shadow-xl transform hover:scale-105 transition-transform duration-200">
                                        <div className="w-52 h-48 overflow-hidden">
                                            <img src={category.imgSrc} alt={category.name} loading="lazy" decoding="async" sizes="(min-width: 1200px) 17vw, (min-width: 1000px) 20vw, (min-width: 640px) 25vw, (min-width: 0px) 30vw, 100vw" className="w-full h-auto object-cover rounded-t-lg" />
                                        </div>
                    ...
                    {/* Right Button */}
                    <button className="absolute right-0 top-1/2 transform -translate-y-1/2 bg-[#ee9613] rounded-bl-[150px] rounded-tl-[150px] p-2 z-20" onClick={() => scrollRight(pharmaciesscroll)}>
                        &#9654; {/* Right Arrow */}
                    </button>
                </div>
                            ...
                            <a href={category.href} className="block w-full h-full rounded-lg bg-slate-50 shadow-md hover:shadow-xl transform hover:scale-105 transition-transform duration-200">
                                <div className="flex flex-col items-start justify-start h-full">
                                    ...
                                    <div className="p-2 w-full">
                                        <h3 data-testid="venue-name" className="font-bold">{category.name}</h3>

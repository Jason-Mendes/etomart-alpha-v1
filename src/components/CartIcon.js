...
const CartIcon = () => {
  ...
  <button
    ...
    >
      <span
        className="icon-container absolute left-[-50px] w-8 h-8 bg-transparent rounded-full flex items-center justify-center overflow-hidden z-20 transition duration-500"
      >
        <svg

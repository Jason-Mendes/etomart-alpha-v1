        ...
        >
          ...
          <div id="Image_and_Form_Container" className="flex flex-col md:flex-row items-center justify-center flex-grow">
            ...
            <div className="flex flex-col justify-center mb-8 md:mb-0">
              <h2 className="text-center text-[#000000] text-2xl md:text-4xl lg:text-5xl font-Agbalumo font-bold mb-4">Login / Sign Up</h2>
            ...
            <div className="flex flex-col justify-center md:ml-16 w-full md:w-1/2">
              <h2 className="text-center text-[#000000] text-2xl md:text-3xl lg:text-4xl font-Agbalumo font-bold mb-6">Welcome Back!</h2>
              ...
              {/* Email input */}
              <div className="py-4">
                <span className="text-black text-xl md:text-2xl font-Agbalumo font-semibold mb-2">Email</span>
                <input
                  type="text"
              ...
              <div className="flex justify-between w-full py-4">
                <div className="flex items-center">
                  <input type="checkbox" name="ch" id="ch" className="h-5 w-5 mr-2" />
              ...
              <div className="text-center text-black">
                <span className="text-center text-white font-semibold text-lg mr-2">Don't have an account?</span>
                <button onClick={handleSignupLinkClick} className="text-white hover:text-black font-semibold text-lg underline">
                  Sign up for free
                </button>
              </div>
            </div>

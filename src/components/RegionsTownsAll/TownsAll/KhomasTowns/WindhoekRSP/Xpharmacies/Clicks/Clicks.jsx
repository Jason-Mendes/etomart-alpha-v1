...
const extendedCards = useMemo(() => [...cards, ...cards, ...cards], [cards]);
  ...
  const renderStoreCard = useCallback((category, index) => (
    <div key={index} className="w-48 shrink-0 p-6 sm:w-56 md:w-64 lg:w-72">
      <a href={category.href} className="block h-full rounded-lg bg-slate-50 shadow-md transition-transform duration-200 hover:scale-105 hover:shadow-xl">
      ...
      <main className="relative z-10">
        ...
        <header className="relative">
          ...
          <div className="absolute bottom-0 left-0 flex w-full items-center justify-between p-4">
            <div className="px-4">
              <h1 className="text-4xl font-bold text-white">Clicks</h1>
              <p className="text-lg text-white">Feel Good Pay Less</p>
              <button
            ...
            <div className="space-y-8 md:w-1/3">
              <div className="space-y-8">
                <div>
                  ...
                  <p className="font-bold text-[#ee9613]">Clicks</p>

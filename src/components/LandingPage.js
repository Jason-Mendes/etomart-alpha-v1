  ...
  return (
    <div id="Landing_Page_Main_Body" className="content-wrapper ">
      <div className="overflow-hidden">
        {/* Hero Section */}
        {/* Orange Section */}
        <div className="bg-[#ee9613] border border-solid border-white-A700_19 rounded-bl-[150px] rounded-br-[150px] shadow-xl relative p-4 w-full overflow-auto">
              ...
              <div className="flex flex-col items-center">
                <nav>
                  <div className="flex text-center p-2 mb-0">
                    <p className="text-lg font-Agbalumo text-black ">
                      Company Links
                    </p>
                  </div>
                      ...
                      {companyLinks.map((link, index) => (
                        <li key={index.label}>
                          <a
                            href={link.url}
                            target={link.target}
                            className="text-white font-josefin_sans hover:text-black transition duration-150 ease-in-out"
                          >
                            {link.label}
                          </a>
                        </li>
          ...
          <div className="container mx-auto  flex flex-col md:flex-row justify-between items-center bg-[#ee9613] py-4">
            <div className="flex flex-row md:flex-row items-center md:items-start space-x-4 md:space-x-8">
              <button
                ...
                className="flex font-Agbalumo items-center text-zinc-950 hover:text-zinc-50 transition-colors"
              ...
              <button
                ...
                className="flex font-Agbalumo items-center space-x-2 text-zinc-950 hover:text-zinc-50 transition-colors"

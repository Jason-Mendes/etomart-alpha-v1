...
function LandingPage() {
  ...
  //Regions stuff
  const regions = [
    { code: 'ALB', name: 'Khomas', flagPath: '/images/regions/khomas.jpeg', path: 'src/components/Regions/khomasLandingPage.js' },
  ...
  return (
    <div id="Landing_Page_Main_Body" className="content-wrapper ">
      <div className="overflow-hidden">
        ...
        <div id="LP_location_buttons_container_2" className="flex items-center justify-center  p-8 mx-auto sm:max-w-full md:max-w-screen lg:max-w-screen xl:max-w-screen 2xl:max-w-screen" style={{ maxWidth: '1800px', marginLeft: 'auto', marginRight: 'auto' }}>
          <div id="LP_Did_you_know_container_4" class="flex flex-col gap-[35px] items-center justify-start w-auto md:w-full pt-16 pb-6">
            ...
            <div class="flex flex-col items-center justify-center px-2.5 py-[3px] w-auto">
              <p class="text-center sm:text-[21px] md:text-[23px] text-[25px] max-w-xl text-zinc-950_01 font-josefin_sans font-semibold">Lorem ipsum dolor sit amet consectetur. Non tincidunt magna non et elit. Dolor turpis molestie dui magnis facilisis at fringilla quam.</p>
            </div>
          </div>
        </div>
            ...
            <div id="LP_testimonials_container_4" className="flex flex-col items-center gap-[35px] justify-start w-full pt-16 pb-16 px-4 md:px-10">
              ...
              <div className="flex transition-transform duration-500 ease-in-out transform" key={currentSlide}>
                {testimonials.map((testimonial, index) => (
                  <div
                    key={index}
                    className={`bg-white border border-slate-200   rounded-bl-[200px] rounded-br-[200px] rounded-tl-[200px] rounded-tr-[200px] shadow-md max-w-full md:max-w-[928px] p-6 ${currentSlide === index ? 'opacity-100' : 'opacity-0 absolute'}`}>
        ...
        <div id="LP_location_buttons_container_2" className="flex items-center justify-center  p-8 mx-auto sm:max-w-full md:max-w-screen lg:max-w-screen xl:max-w-screen 2xl:max-w-screen" style={{ maxWidth: '1800px', marginLeft: 'auto', marginRight: 'auto' }}>
          ...
          <div className="flex flex-col items-center justify-center px-2.5 py-20  w-auto">
            <h2 className="text-5xl font-Agbalumo font-bold mb-16">Hungry for more than food?</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 p-6">
                ...
                <div className="p-0 m-2">
                  ...
                  <div className="flex flex-col items-center justify-center p-0">
                    <div className="flex flex-col items-center justify-center  max-w-[340px] h-[120px]">
                      <p className="text-center text-lg font-josefin_sans font-bold overflow-hidden line-clamp-3 m-2 p-0">Get paid as a courier partner</p>
              ...
              <div className="p-0 m-2 bg-white shadow-md rounded-lg overflow-hidden border border-solid border-slate-100">
                <div className="p-0 m-2">
                  ...
                  <div className="flex flex-col items-center justify-center p-0">
                    <div className="flex flex-col items-center justify-center  max-w-[340px] h-[120px]">
                      <p className="text-center text-lg font-josefin_sans font-bold overflow-hidden line-clamp-3 m-2 p-0">Serve more people as a restaurant partner</p>
              ...
              <div className="p-0 m-2 bg-white shadow-md rounded-lg overflow-hidden border border-solid border-slate-100">
                <div className="p-0 m-2">
                  ...
                  <div className="flex flex-col items-center justify-center p-0">
                    <div className="flex flex-col items-center justify-center  max-w-[340px] h-[120px]">
                      <p className="text-center text-lg  font-josefin_sans font-bold overflow-hidden line-clamp-3 m-2 p-0">Enter a new chapter and find a job at Etomart</p>
      ...
      <div
          id="LP_section_3_orange"
          className="flex flex-col items-center justify-center bg-[#ee9613] border border-solid border-white-A700_19 rounded-tl-[150px] rounded-tr-[150px] shadow-xl relative md:p-10 p-5"
          style={{ width: '100%', maxWidth: '100vw', margin: '0 auto' }}>
          
            <div className=" flex items-center gap-6 justify-center" >
            <div className=" flex flex-col gap-0 items-start justify-between">
              <div className="flex items-start justify-start ">
                <div className="wpt-ui-Footer_StyledLogo_s19k4r2o">
                  <div class="flex justify-start items-center mt-0 mb-8">
                    <h1 class=" text-3xl font-shrikhand text-[#000000] whitespace-nowrap"><a href="/LandingPage">Etomart</a></h1>
                  </div>
                </div>
              </div>
              <div className="wpt-ui-AppLinks_Root_rr05kqb flex flex-row md:flex-row">
                <a
            ...
            <div className="p-4 grid grid-cols-3 md:grid-cols-5 gap-6">

              <div className="flex flex-col items-center justify-center   h-[120px]">
                <nav className="">
                  <div className="flex text-center p-2 w-48">
                    <p className="text-lg text-gray-800_02 font-bold mb-2">Convenient Tracking</p>
                  </div>
          ...
          <div className=" flex flex-col pt-4 pb-4 md:flex-row items-start justify-center">
            <div className="wpt-ui-Footer_Settings_svz6bg1 flex items-start justify-between space-x-4 -ml-5">
              <button
                ...
                <svg viewBox="0 0 24 24" className="SettingsItem-icon h-5 w-5">
                  {/* SVG icon path */}
                </svg>
                <span>English</span>
              </button>
              <button
                ...
                className="wpt-ui-SettingsItem_Root_rayx5vb flex items-center space-x-2 text-zinc-950 hover:text-zinc-50 transition-colors"
            ...
            <div className="wpt-ui-Footer_Settings_svz6bg1 flex space-x-4">
              <button
                aria-label="Change language"
                data-test-id="Footer.OpenLanguageSelectionDialogButton"
                className="wpt-ui-SettingsItem_Root_rayx5vb flex items-center space-x-2 text-zinc-950 hover:text-zinc-50 transition-colors"
              ...
              <div className="wpt-ui-Footer_Attribution_a1dnjeod text-zinc-950 mt-4 md:mt-0">©️ Etomart 2024
              </div>
            </div>
          </div>
        </div>
